...
.L95:
	...
	cmpl	-296(%rbp), %eax
	jg	.L96
	.loc 3 265 0 is_stmt 1
	addl	$1, -300(%rbp)
.L94:
	.loc 3 265 0 is_stmt 0 discriminator 1
	movl	GV(%rip), %eax
	cmpl	-300(%rbp), %eax
	jg	.L97
...
.L101:
	...
	addl	$1, -300(%rbp)
.L100:
	.loc 3 300 0 is_stmt 0 discriminator 1
	movl	GV(%rip), %eax
	cmpl	-300(%rbp), %eax
	jg	.L103
	...
	addl	$1, -304(%rbp)
.L99:
	.loc 3 298 0 is_stmt 0 discriminator 1
	movl	GV(%rip), %eax
	cmpl	-304(%rbp), %eax
	jg	.L104
