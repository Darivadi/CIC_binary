...
.L94:
	...
	subsd	%xmm1, %xmm0
	movsd	%xmm0, 40(%rdx)
	.loc 3 272 0 discriminator 2
	addl	$1, -328(%rbp)
.L93:
	.loc 3 272 0 is_stmt 0 discriminator 1
	movl	GV(%rip), %eax
	cmpl	-328(%rbp), %eax
	jg	.L94
...
.L92:
	...
	cmpl	-332(%rbp), %eax
	jg	.L95
	.loc 3 268 0 is_stmt 1
	addl	$1, -336(%rbp)
.L91:
	.loc 3 268 0 is_stmt 0 discriminator 1
	movl	GV(%rip), %eax
	cmpl	-336(%rbp), %eax
	jg	.L96
	.loc 3 304 0 is_stmt 1
	call	write_binary
	.loc 3 308 0
	movl	-308(%rbp), %eax
	movl	%eax, %esi
